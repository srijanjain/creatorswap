sudo sed -i 's/0x5CF874C2f969a53b75d18e9e719c65120000dD5E/0xe1662823d8044254409eB682fE34d35792677228/g' src/constants/index.ts #Router Address
echo "------------------------------------------------------Done1------------------------------------------------------"
...
sudo cp -r ../canvaswap-libs/sdk/ node_modules/@pancakeswap-libs/
echo "------------------------------------------------------Done------------------------------------------------------"